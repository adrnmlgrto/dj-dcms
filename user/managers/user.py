...
class CustomUserManager(BaseUserManager):
    """
    The manager class for a user model.

    This model manager makes use of the user's `email` field as
    the unique identifier for authentication instead of the
    ...
    def create_user(
        ...
        Returns:
            User: A created instance of the user model.
        ...
        # Initialize the user model, and set the password.
    ...
    def create_staff(
        ...
        Returns:
            User: A created staff user instance of the user model.
    ...
    def create_superuser(
        ...
        Returns:
            User: A created superuser instance of the user model.
